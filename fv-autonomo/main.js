...
function calcAutonomo() {
  ...
  if (demandaMax <= 2000) {
    ...
    verMas = {
      ...
      modulo: "https://autosolar.co/pdf/ERA-Mono-PERC-325W-60c.pdf",
      inversor:
  ...
  } else if ((demandaMax <= 16001) & (demandaMax > 4001)) {
    volSistm = 48;
    eficienciaInversor = 0.93;
    modulo = {
      potencia: 325,
